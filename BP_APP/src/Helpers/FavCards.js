              ...
              <TouchableOpacity
                onPress={async () => {
                  if (this.state.heart === false) {
                    ...
                    axios
                      .post(
                        "https://damp-beyond-36191.herokuapp.com/add/favourite",
                        {
                          userId: this.props.user.user._id,
                    ...
                    axios
                      .delete(
                        "https://damp-beyond-36191.herokuapp.com/delete/favourite/" +
                          this.props.user.user._id +
                          "/" +
                  ...
                  axios
                    .put(
                      "https://damp-beyond-36191.herokuapp.com/edit/favourites/" +
                        this.props.product.product._id,
                      {
                  ...
                  onPress={() => {
                    if (this.props.cart.length === 0) {
                      ...
                      if (this.props.store === "") {
                        axios
                          .get(
                            "https://damp-beyond-36191.herokuapp.com/get/store/" +
                              this.props.product.product.storeId
                          )
                          .then((resp) => {
