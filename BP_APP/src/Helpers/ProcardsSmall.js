          ...
          <TouchableOpacity 
             onPress={async() =>{
              if(this.state.heart === false){
                  ...
                  axios.post('https://damp-beyond-36191.herokuapp.com/add/favourite',{
                ...
                axios.delete('https://damp-beyond-36191.herokuapp.com/delete/favourite/'+this.props.user.user._id+'/'+this.props.product._id)
                .then(resp =>console.log(resp))
                .catch(err => err)

              }

              axios.put('https://damp-beyond-36191.herokuapp.com/edit/favourites/'+this.props.product._id,{
