...
class Cart extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "https://mysterious-anchorage-22807.herokuapp.com/get/store/" + this.props.store.id
      )
      .then((resp) => {
        this.setState({
  ...
  makeid(length) {
   ...
   axios
      .get("https://mysterious-anchorage-22807.herokuapp.com/get/order/bynumber/" + result)
      .then((resp) => {
        if (resp.data === null) {
          // /edit/store/orderNum/
        } else {
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                    ...
                    // if (timeCheck) {
                      axios
                        .post(
                          "https://mysterious-anchorage-22807.herokuapp.com/add/order",
                          {
                            storeId: sId,
