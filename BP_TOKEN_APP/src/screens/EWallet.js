...
class MyOrders extends Component {
  ...
  componentDidMount() {
    // axios
    //   .get(
    //     "https://mysterious-anchorage-22807.herokuapp.com/get/wallet/user1/" +
    ...
    //   .catch((err) => console.log(err));
      ...
      // axios
      // .get(
      //   "https://mysterious-anchorage-22807.herokuapp.com/get/stores/"
      // )
      // .then((resp) => {
      //   this.setState({
      //     wallet: resp.data,
      ...
      <View style={{ flex: 1, backgroundColor: "white" }}>
        <ScrollView>
            {this.state.wallet.map((item,index) => (
                <WalletCard  id={item._id} storeName={item.storeName} item={item} navigation={this.props.navigation}
                />
            ))}
        </ScrollView>
      </View>
