              ...
              <TouchableOpacity
                onPress={async () => {
                  if (this.state.heart === false) {
                    ...
                    axios
                      .post(
                        "https://mysterious-anchorage-22807.herokuapp.com/add/favourite",
                        {
                          userId: this.props.user.user._id,
                    ...
                    axios
                      .delete(
                        "https://mysterious-anchorage-22807.herokuapp.com/delete/favourite/" +
                          this.props.user.user._id +
                          "/" +
                  ...
                  axios
                    .put(
                      "https://mysterious-anchorage-22807.herokuapp.com/edit/favourites/" +
                        this.props.product.product._id,
                      {
            ...
            <View style={{ flex: 1, flexDirection: "row", paddingTop: 5 }}>
              ...
              <View style={{ marginLeft: 5 }}>
                <LatoText
                  ...
                  text={"pkr  " + this.props.product.product.price + " / unit"}
                ></LatoText>
              </View>
            </View>
                  ...
                  onPress={() => {
                    if (this.props.cart.length === 0) {
                      ...
                      if (this.props.store === "") {
                        axios
                          .get(
                            "https://mysterious-anchorage-22807.herokuapp.com/get/store/" +
                              this.props.product.product.storeId
                          )
                          .then((resp) => {
